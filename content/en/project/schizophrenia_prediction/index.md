...
names: [Hugo Galván, Agustina Bóveda, Sebastián Galván, Pablo Koss]
...
tags: [schizophrenia spectrum and other psychotic disorders, diffusion tensor imaging, machine learning]

# Summarize your project in < ~75 words. This description will appear at the top of your page and on the list page with other projects..

summary: "Psychosis involves significant alterations in perception, thoughts, mood, and behavior. Schizophrenia (SZ) is the most common psychotic disorder with substantial burdens. Abnormal connectivity within the basal ganglia-thalamo-cortical circuit plays a critical role in SZ's pathophysiology. The prefrontal cortex is central to SZ's cognitive aspects. Early diagnosis using machine learning and structural MRI can facilitate targeted interventions and identification of biomarkers. This project aims to develop an AI model based on prefrontal cortex connectomics for SZ diagnosis. [website](https://school.brainhackmtl.org/project)."
